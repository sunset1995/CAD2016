...
#include "sources/yasat/clause.h"
#include "sources/yasat/disjointset.h"
#include "sources/yasat/opstack.h"
#include "sources/yasat/statistic.h"
#include "sources/yasat/lazytable.h"
#include "sources/yasat/heap.h"
#include <sys/time.h>
#include <cmath>
#include <cstdlib>
#include <vector>
...
public:
    ...
    void init(const vector< vector<int> > &rth, int maxIdx);
    bool solve(int mode);
